...
SKIN.PrintName          = "kazmotd"
SKIN.Author             = "Kazaki"
SKIN.DermaVersion       = 1

SKIN.colOutline 		= Color( 0, 0, 0, 255 )
...
SKIN.colPropertySheet	= Color( 220, 250, 140, 255 )
SKIN.colTab				= SKIN.colPropertySheet
SKIN.colTabText			= Color( 0, 0, 0, 200 )
SKIN.fontButton 		= "tabfont"
SKIN.fontTab			= "tabfont"
SKIN.fontFrame			= "tabfont"

SKIN.bg_color 			= Color(233, 152, 37, 255)
SKIN.m_bgColor			= Color( 0, 0, 0, 255 )
SKIN.panelcolor 		= Color(0, 0, 0, 255)
...
function SKIN:PaintPropertySheet( panel )
	...
	draw.RoundedBox( 0, 5, 25, panel:GetWide()-10, panel:GetTall()-30, self.bg_color)
	
end

derma.DefineSkin( "kazmotd_default", "Default skin for KazMOTD", SKIN )
